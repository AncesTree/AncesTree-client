import { FETCH_LINEAGE_SUCESS, FETCH_LINEAGE_ERROR, FETCH_RESEARCH_SUCESS, FETCH_RESEARCH_ERROR, FETCH_PROMO_ERROR,FETCH_PROMO_SUCESS } from '../actions/Tree'
...
const tree = (state = initialState, action) => {
  switch (action.type) {
    ...
    case FETCH_RESEARCH_ERROR:
      ...
      case FETCH_PROMO_SUCESS:
      return Object.assign({}, state, initialState, {
        searchResult: action.results.promo
